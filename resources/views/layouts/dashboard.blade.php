        ...
        <footer class="footer font-small">
            <div class="row mx-auto justify-content-center text-center pb-3 border-top">
                ...
                <div class="col-lg-2 col-12 offset-lg-1">
                    ...
                    <hr class="border-white mt-1 mb-1">
                    <a href="{{ route('dashboard.staticsites.index') }}">Strony statyczne</a>
                    <br>
                    <a href="{{ route('dashboard.news.index') }}">Aktualności</a>
                    <br>
                    <a href="{{ route('dashboard.contact.index') }}">Kontakt</a>
                </div>
